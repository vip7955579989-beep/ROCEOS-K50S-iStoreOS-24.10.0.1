...
# 3. 预先注入 U-Boot 引导固件到 staging_dir
...
# 4. 在 armv8.mk 中添加 ROCEOS K50S 设备定义
...
define Device/roceos_k50s
  ...
  DEVICE_PACKAGES := kmod-r8125 kmod-r8169 kmod-phy-realtek
endef
